...
impl<const USE_CACHE: bool> ConTreeLds<USE_CACHE> {
    ...
    pub fn partial_fit(&mut self, root_view: &DataView) -> bool {
        ...
        let search_exhausted = self.is_search_exhausted(self.config.budget, self.split_budget);
    ...
    fn is_search_exhausted(&self, feat_budget: usize, split_budget: usize) -> bool {
