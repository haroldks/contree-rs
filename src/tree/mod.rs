...
impl Tree {
    ...
    fn cleanup_leaves(&mut self, index: usize) {
        ...
        if has_children
            && self.is_leaf(left)
            && self.is_leaf(right)
            && self.node_label(left).eq(&self.node_label(right))
        {
            let output = self.node_label(right).unwrap();
            self.update_node(index)
                .map(|updater| updater.label(output).clean_test().leaf());
        }
    }
...
//         assert_eq!(data.feature.is_none(), true);
...
//         assert_eq!(left_node.value.feature, Some(15));
//     }
//
//     #[test]
...
//         assert_eq!(right_node.value.feature, Some(15));
//     }
//
//     #[test]
//     fn test_get_node() {
...
//         let root_index = tree.get_root_index();
//         let root = tree.get_node(root_index).unwrap();
//         assert_eq!(Some(33), root.value.feature)
//     }
//
//     #[test]
...
//         root.value.feature = Some(12);
//         assert_eq!(Some(12), root.value.feature);
//     }
//
//     #[test]
...
//         let root = tree.get_node(root_index).unwrap();
//         let left_node = tree.get_left_child(root).unwrap();
//         assert_eq!(left_node.value.feature, Some(11));
//     }
//
//     #[test]
...
//         let root = tree.get_node(root_index).unwrap();
//         let right_node = tree.get_right_child(root).unwrap();
//         assert_eq!(right_node.value.feature, Some(22));
//     }
// }
