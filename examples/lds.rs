...
use pytrees_continuous::algorithms::GenericConTree;
use pytrees_continuous::common::Statistics;
use pytrees_continuous::data::view::DataView;
...
pub fn push_from_stats(result: &mut Res, stats: &Statistics) {
    ...
    result.specialized_solver_call.push(stats.specialized_solver_call);
